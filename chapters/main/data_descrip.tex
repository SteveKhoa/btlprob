...
MAY NEN VIET CAI GI DO O DAY DE GIOI THIEU TRUOC KHI VAO PHAN NAY.!!!!!

\textbf{Preparing the data}

\inputcode[firstline=21,lastline=28]{R}{rcode/cleaning.r}
...
\begin{center}
    \begin{tabularx}{\linewidth}{l*{2}{X}}
        ...
        \verb|Temperature -> tmp| & &                                                                   \\
        \bottomrule
    \end{tabularx}
\end{center}

\inputcode[firstline=30,lastline=34]{R}{rcode/cleaning.r}
