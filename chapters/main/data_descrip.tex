...
\includegraphics[max width=0.9\linewidth]{An image of the dataset before cleaning should be here}
...
\includegraphics[max width=0.9\linewidth]{An image of the data after cleaned should be here}