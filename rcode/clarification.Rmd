...
ggplot(data, aes(x = tdp)) +
  geom_histogram(binwidth = 5, fill="deepskyblue") # histogram of residuals
...
# Model
model.l <- glm(type ~ temp, data = train, family = 'binomial') # Model 1
